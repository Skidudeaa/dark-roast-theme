...
**As of 2026-08-29. Package 5.10.3, doctrine contract 0.4.1. `npm test` is green; CI runs static gates plus Chromium/axe/visual proof on every push to `master`.**
...
**1. The theme family** (npm package `dark-roast-theme`, currently v5.10.3) answers *what color is this?* The original Black Label remains the unchanged default; ten additive companions serve different ambient conditions. Targets: CSS, ES modules, JSON, SwiftUI, VS Code, Xcode, Textastic, Warp, Tabby, Terminal.app, iTerm2, and Blink. Namespace: `--dr-*`.
