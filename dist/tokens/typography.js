...
// Font stacks, type scale, letter-spacing, semantic roles.
...
export const text5xl = { size: '64px', rem: '4rem', lineHeight: 1, tracking: '-0.03em', weight: 900 };

// ── Legacy v3 rem-only size tokens ──
export const textXsRem = '0.6875rem';
export const textSmRem = '0.8125rem';
export const textBaseRem = '0.9375rem';
export const textLgRem = '1.125rem';
export const textXlRem = '1.5rem';
export const text2xlRem = '2rem';
export const textHuge = '4.5rem';
