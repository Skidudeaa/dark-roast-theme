...
// ============================================================================
// Dark Roast: Cold Brew — Blink Shell Theme (iOS / iPadOS)
...
//        `gh gist create "platforms/blink/Dark Roast Cold Brew.js"`
//     2. In Blink: type `config` (or press ⌘,) → Appearance → Themes → New Theme
//     3. Paste the URL of the JS theme
//     4. Back in Appearance → Theme → select "Dark Roast Cold Brew"
//
...
//   0 black       #D8CFC7   obsidian  — dark but not void; provides depth in dark bg
//   1 red         #940015   scarlet   — error / critical
//   2 green       #0F3E02   sage      — warm fern green (terminal extension)
...
//   8  bright black    #7D6F5F   crater-deep   — comment gray / muted metadata
...
const darkRoastColdBrew = {
  // ── ANSI normal (0–7) ─────────────────────────────────────────────────────
  black: "#D8CFC7", // obsidian — elevated floor, not as deep as void
  red: "#940015", // scarlet — error / critical severity
  green: "#0F3E02", // sage — warm fern; git diff +lines, ls dirs
  yellow: "#492B00", // amber — warning / accent; DR primary CTA
  blue: "#003F60", // slate — dusty steel; git diff header, less prompt
  magenta: "#472077", // mauve — dried lavender; grep matches, vim special
  cyan: "#004444", // teal — live data; matches cursor + DR teal token
  white: "#100701", // bone — reduced-contrast; comment-level brightness

  // ── ANSI bright (8–15) ────────────────────────────────────────────────────
  lightBlack: "#7D6F5F", // crater-deep — comment gray; git log graph, tmux inactive
  ...
  // ── Chrome ────────────────────────────────────────────────────────────────
  backgroundColor: "#E2DDD7", // void — warm-dark deepest layer
...
t.prefs_.set('color-palette-overrides', [
  darkRoastColdBrew.black,
  darkRoastColdBrew.red,
  darkRoastColdBrew.green,
  darkRoastColdBrew.yellow,
  darkRoastColdBrew.blue,
  darkRoastColdBrew.magenta,
  darkRoastColdBrew.cyan,
  darkRoastColdBrew.white,
  darkRoastColdBrew.lightBlack,
  darkRoastColdBrew.lightRed,
  darkRoastColdBrew.lightGreen,
  darkRoastColdBrew.lightYellow,
  darkRoastColdBrew.lightBlue,
  darkRoastColdBrew.lightMagenta,
  darkRoastColdBrew.lightCyan,
  darkRoastColdBrew.lightWhite
]);

t.prefs_.set('foreground-color', darkRoastColdBrew.foregroundColor);
t.prefs_.set('background-color', darkRoastColdBrew.backgroundColor);
t.prefs_.set('cursor-color', darkRoastColdBrew.cursorColor);
