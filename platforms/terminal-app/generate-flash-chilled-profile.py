...
"""
Dark Roast: Flash Chilled — Terminal.app Profile Generator
Version: 5.1.0 Companion

WHAT THIS SCRIPT DOES
---------------------
Generates "Dark Roast Flash Chilled.terminal" — an Apple Terminal.app color
...
- Python 3 — use the SYSTEM python3, not a venv or Homebrew python, because
  PyObjC is only available on the system installation:
    /usr/bin/python3 generate-flash-chilled-profile.py

  DO NOT use:
    python3 generate-flash-chilled-profile.py   (if python3 points to Homebrew)
    ~/.pyenv/shims/python3 ...
...
2. A file named "Dark Roast Flash Chilled.terminal" will be created in the
   current directory (same folder as this script).

3. Double-click "Dark Roast Flash Chilled.terminal" in Finder, OR:
     open "Dark Roast Flash Chilled.terminal"
...
4. To activate permanently:
   Terminal.app → Settings → Profiles → select "Dark Roast Flash Chilled"
...
def main():
    ...
    output_path = os.path.join(output_dir, "Dark Roast Flash Chilled.terminal")

    print("Dark Roast: Flash Chilled — Terminal.app Profile Generator")
    print("=" * 60)
    ...
    print("     select 'Dark Roast Flash Chilled' → click 'Default'.")
    print()
